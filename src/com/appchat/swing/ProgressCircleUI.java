...
public class ProgressCircleUI extends BasicProgressBarUI {
    ...
    public ProgressCircleUI(Progress pro) {
        this.pro = pro;
        imageDown = new ImageIcon(getClass().getResource("/com/appchat/icon/save.png")).getImage();
        imageCancel = new ImageIcon(getClass().getResource("/com/appchat/icon/cancel.png")).getImage();
        imageFile = new ImageIcon(getClass().getResource("/com/appchat/icon/file.png")).getImage();
    }
